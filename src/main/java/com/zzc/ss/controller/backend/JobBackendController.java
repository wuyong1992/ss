...
public class JobBackendController {
    ...
    public ServerResponse getJonInfoList(@PageableDefault Pageable pageable,
        ...
        Page<JobInfo> page = jobService.getJonInfoList(pageable, jobCategoryId, enterpriseId, status);
